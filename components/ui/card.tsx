...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-gray-200 bg-white text-black shadow-sm transition-all hover:shadow-lg hover:border-gray-300 overflow-hidden flex flex-col",
      className
    )}
    {...props}
  />
...
export { Card, CardContent, CardTitle, CardDescription, CardVisual }
