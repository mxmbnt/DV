        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <a href="#" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-black">DIGITALVISION</span>
            </a>
          ...
          {/* Services */}
          <div>
            <h4 className="font-semibold text-black text-sm mb-4">Services</h4>
          ...
          {/* Navigation */}
          <div>
            <h4 className="font-semibold text-black text-sm mb-4">Navigation</h4>
            <ul className="space-y-3 text-sm text-gray-500">
          ...
          {/* Légal */}
          <div>
            <h4 className="font-semibold text-black text-sm mb-4">Légal</h4>
            <ul className="space-y-3 text-sm text-gray-500">
